...
RESOURCES CONSULTED FOR DIFFERENT PORTIONS

For middleware n arrays
http://expressjs.com/en/api.html#express.urlencoded 

For mongoose n model stuff
https://mongoosejs.com/docs/models.html 

Express templating
https://ejs.co/#docs 

Document Object Model (DOM) + manipulations n such
https://www.w3schools.com/js/js_htmldom.asp 
https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model 

Bundling repeated names into arrays (reason why the card input fields actually work 
